...
Rectangle
{
    ...
    MouseArea
    {
        ...
        onPressed: (mouse) =>
            {
                var cX = mouse.x - minusOperatorPlate.radius
                var cY = mouse.y - minusOperatorPlate.radius

                if (cX * cX + cY * cY <= minusOperatorPlate.radius * minusOperatorPlate.radius)
                    isClicked = true
            }
